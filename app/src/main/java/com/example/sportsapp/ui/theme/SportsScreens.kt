...
import com.example.sportsapp.data.LocalSportsDataProvider
import com.example.sportsapp.model.Sport
import com.example.sportsapp.utils.SportsContentType
    ...
    Scaffold(
        topBar = {
            AppBarComponent(
                ...
                onBackClick = { viewModel.navigateToListPage() },
...
@OptIn(ExperimentalMaterial3Api::class)
@Composable
private fun SportListItemComponent(
    sport: Sport,
    ...
    Card(
        ...
        Row(
            ...
            SportThumbnail(sport, Modifier.size(dimensionResource(R.dimen.card_image_height)))
            Column(
                modifier = Modifier
                    .padding(
...
@Composable
fun SportThumbnail(sport: Sport, modifier: Modifier = Modifier) {
